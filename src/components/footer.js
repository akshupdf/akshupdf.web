...
<footer className="p-4 bg-white sm:p-6 ">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="https://akshupdfweb.netlify.app/" className="flex items-center">
                <img src={logo} className="h-[10vh] w-[30vh] mr-3" alt="Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between mt-10">
        <span className="text-sm text-black sm:text-center ">© 2023 <a href="https://akshupdfweb.netlify.app/" className="hover:underline">akshupdf.web™</a>. All Rights Reserved.
        </span>
        <div className="lg:flex mt-4 space-x-6 sm:justify-center sm:mt-0 mr-auto ">
            <a href="https://www.facebook.com/akshupdf/" className="text-black hover:text-gray-900 ml-10">
            ...
            <a href="https://www.instagram.com/akshupdf.web/" className="text-black hover:text-gray-900 ">
